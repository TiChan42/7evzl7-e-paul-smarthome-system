...
---------------------------------------------------------------------------------
SSID\0Password\0Topic\0ID\0Key
---------------------------------------------------------------------------------
*/
...
void writeTopicToEEPROM(int address, String data) {
  int topicStart = readSSIDFromEEPROM(address).length() + readPasswordFromEEPROM(address).length() + 2; //ab hier beginnt das Passwort
...
void writeIDToEEPROM(int address, String data) {
  int idStart = readSSIDFromEEPROM(address).length() + readPasswordFromEEPROM(address).length() + readTopicFromEEPROM(address).length() + 3; //ab hier beginnt das Passwort
...
void writeKeyToEEPROM(int address, String data) {
  int keyStart = readSSIDFromEEPROM(address).length() + readPasswordFromEEPROM(address).length() + readTopicFromEEPROM(address).length() + readIDFromEEPROM(address).length() + 4; //ab hier beginnt das Passwort
